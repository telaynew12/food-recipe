import{Q as E,w as x}from"./b04z4mtb.js";import{_ as N}from"./stacktrace-list.vue-znh71v05.js";import{k as y,l as m,S as u,a0 as w,$ as C,U as f,a5 as d,W as _,M as S,Q as i,a6 as $}from"./vendor/json-editor-vue-nhjd65sz.js";import"./vendor/unocss-pcs99qrd.js";import"./vendor/shiki-enrzjv18.js";import"./filepath-item.vue-fxcmp74h.js";const O=/(^|@)\S+:\d+/,h=/^\s*at .*(\S+:\d+|\(native\))/m,R=/^(eval@)?(\[native code\])?$/;function F(e,a){if(typeof e.stacktrace<"u"||typeof e["opera#sourceloc"]<"u")return V(e);if(e.stack&&e.stack.match(h))return I(e);if(e.stack)return A(e);throw new Error("Cannot parse given Error object")}function v(e){if(!e.includes(":"))return[e,void 0,void 0];const r=/(.+?)(?::(\d+))?(?::(\d+))?$/.exec(e.replace(/[()]/g,""));return[r[1],r[2]||void 0,r[3]||void 0]}function p(e,a){return e}function I(e,a){return b(e.stack)}function b(e,a){return p(e.split(`
